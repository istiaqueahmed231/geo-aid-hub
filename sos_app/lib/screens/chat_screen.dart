...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _fetchMessages() async {
    try {
      final res = await http.get(Uri.parse('https://geo-aid-hub.onrender.com/api/messages/${widget.requestId}')); // Assuming production URL
    ...
    try {
      await http.post(
        ...
        body: jsonEncode({
          ...
          'senderRole': 'Victim',
          'senderId': 'Victim_${widget.requestId}', 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Chat with Rescue Team')),
      body: Column(
        children: [
          Expanded(
